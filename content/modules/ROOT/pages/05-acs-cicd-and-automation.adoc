...
[start=1]
. Log into the OCP console at `{openshift_cluster_console_url}`:
...
[start=4]
. Enter the OpenShift username *{openshift_cluster_admin_username}* and password: *{openshift_cluster_admin_username}*:
