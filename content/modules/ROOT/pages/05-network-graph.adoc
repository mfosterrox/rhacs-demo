...
image::05-network-graph-overview.png[Network Graph showing deployment-level traffic flows across Payments and other namespaces,link=self,window=blank,width=700,title="Network Graph with multiple namespaces selected"]

// TODO: Capture screenshot of the Network Graph with Payments namespace visible
...
image::05-network-deployment-flows.png[Deployment detail panel for visa-processor showing one anomalous flow and three baseline flows,link=self,window=blank,width=700,title="Deployment network flows showing anomalous connection"]

// TODO: Capture screenshot of the visa-processor deployment flows panel
...
image::05-network-policy-generator.png[Network Policy Simulator showing generated Kubernetes Network Policy YAML for the Payments namespace,link=self,window=blank,width=700,title="Network Policy Simulator output"]

// TODO: Capture screenshot of the Network Policy generator with YAML output visible

== Assets needed

. `content/modules/ROOT/assets/images/05-network-graph-overview.png` -- Network Graph with Payments and other namespaces selected, showing deployment-level traffic flows
. `content/modules/ROOT/assets/images/05-network-deployment-flows.png` -- visa-processor deployment detail panel showing anomalous and baseline flows
. `content/modules/ROOT/assets/images/05-network-policy-generator.png` -- Network Policy Simulator with generated Kubernetes Network Policy YAML
