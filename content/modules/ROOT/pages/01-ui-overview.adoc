...
+
"Each item here represents a core security workflow. We will cover Vulnerability Management, Compliance, Violations, Policy Management, the Network Graph, and Integrations. Platform Configuration at the bottom is where you manage policies, integrations, and access control."
