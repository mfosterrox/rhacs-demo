...
. Point to the resolution options:
+
...
image::04-violations-list.png[Violations page showing a mix of deploy-time and runtime policy violations,link=self,window=blank,width=700,title="Violations event stream"]

// TODO: Capture screenshot of the Violations list

image::04-violations-runtime-detail.png[Runtime violation detail for Ubuntu Package Manager Execution showing process name, arguments, UID, and container ID,link=self,window=blank,width=700,title="Runtime violation forensic detail"]

// TODO: Capture screenshot of a runtime violation detail view
...
image::04-policy-library.png[Policy Management page showing the built-in policy library with lifecycle stage tags,link=self,window=blank,width=700,title="Policy library with lifecycle tags"]

// TODO: Capture screenshot of the Policy Management list

image::04-policy-detail-alpine.png[Alpine Package Manager policy showing Rationale and Guidance sections,link=self,window=blank,width=700,title="Policy detail with Rationale and Guidance"]

// TODO: Capture screenshot of the Alpine Package Manager policy detail
...
image::04-policy-enforcement-actions.png[Policy behavior edit screen showing Inform and Enforce options with Build and Deploy enforcement switches,link=self,window=blank,width=700,title="Policy enforcement configuration"]

// TODO: Capture screenshot of the Policy behavior Actions screen

== Assets needed

. `content/modules/ROOT/assets/images/04-violations-list.png` -- Violations page showing mixed deploy-time and runtime violations
. `content/modules/ROOT/assets/images/04-violations-runtime-detail.png` -- Runtime violation detail with process name, arguments, UID, and container ID
. `content/modules/ROOT/assets/images/04-policy-library.png` -- Policy Management list showing lifecycle stage tags
. `content/modules/ROOT/assets/images/04-policy-detail-alpine.png` -- Alpine Package Manager policy detail with Rationale and Guidance
. `content/modules/ROOT/assets/images/04-policy-enforcement-actions.png` -- Policy behavior Actions screen with Inform and Enforce selected
