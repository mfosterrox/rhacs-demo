...
* VM console access: `virtctl console rhel-webserver -n default` (login: cloud-user, passwordless—press Enter at password prompt). Wait 5–10 minutes after the VM is Running for cloud-init to complete.
