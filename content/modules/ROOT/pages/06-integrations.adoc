...
image::07-integrations-overview.png[Integrations page showing Image Integrations section with registry types,link=self,window=blank,width=700,title="Integrations page overview"]

// TODO: Capture screenshot of the Integrations page
...
image::07-integrations-notifiers.png[Notifier Integrations section showing Slack, Splunk, ServiceNow, and other targets,link=self,window=blank,width=700,title="Notifier integrations overview"]

// TODO: Capture screenshot of the Notifier Integrations section
...
image::07-integrations-supply-chain.png[Integrations page showing Signature Integrations section for Cosign configuration,link=self,window=blank,width=700,title="Signature integrations for supply chain security"]

// TODO: Capture screenshot of the Signature Integrations section

== Assets needed

. `content/modules/ROOT/assets/images/07-integrations-overview.png` -- Integrations page showing Image Integrations section with registry types
. `content/modules/ROOT/assets/images/07-integrations-notifiers.png` -- Notifier Integrations section showing available targets
. `content/modules/ROOT/assets/images/07-integrations-supply-chain.png` -- Signature Integrations section for Cosign configuration
