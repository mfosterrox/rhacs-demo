...
image::06-integrations-overview.png[Integrations page showing Image Integrations section with registry types,link=self,window=blank,width=700,title="Integrations page overview"]
...
image::06-integrations-notifiers.png[Notifier Integrations section showing Slack, Splunk, ServiceNow, and other targets,link=self,window=blank,width=700,title="Notifier integrations overview"]
...
image::06-integrations-supply-chain.png[Integrations page showing Signature Integrations section for Cosign configuration,link=self,window=blank,width=700,title="Signature integrations for supply chain security"]

// TODO: Capture screenshot of the Signature Integrations section

== Assets needed

. `content/modules/ROOT/assets/images/06-integrations-overview.png` -- Integrations page showing Image Integrations section with registry types
. `content/modules/ROOT/assets/images/06-integrations-notifiers.png` -- Notifier Integrations section showing available targets
. `content/modules/ROOT/assets/images/06-integrations-supply-chain.png` -- Signature Integrations section for Cosign configuration
