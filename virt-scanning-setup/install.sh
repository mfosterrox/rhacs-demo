...
display_banner() {
    ...
    echo ""
    echo "You will be prompted for Red Hat subscription credentials to entitle the VM."
    echo "Credentials are used only at deploy time and are not stored in files."
    echo ""
